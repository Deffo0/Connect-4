...
class Director:
    ...
    def __init__(self, screen, pygame, width, height):
        ...
        self.small_font = pygame.font.Font("Resources/FuzzyBubbles-Regular.ttf", 20)
        self.tiny_font = pygame.font.Font("Resources/FuzzyBubbles-Regular.ttf", 14)
        self.medium_font = pygame.font.Font("Resources/FuzzyBubbles-Regular.ttf", 28)
        self.large_font = pygame.font.Font("Resources/FuzzyBubbles-Regular.ttf", 40)
        self.cell_font = pygame.font.Font("Resources/FuzzyBubbles-Regular.ttf", 60)
        self.black = (0, 0, 0)
